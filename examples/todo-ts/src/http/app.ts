import {
  ...
  type InferActionsFromRecord,
} from "@chimpbase/runtime";
import { Hono } from "hono";

type ProjectActionsModule = typeof import("../modules/projects/project.actions.ts");
type TodoActionsModule = typeof import("../modules/todos/todo.actions.ts");
type TodoAuditActionsModule = typeof import("../modules/todos/todo.audit.actions.ts");
type TodoPlatformActionsModule = typeof import("../modules/todos/todo.platform.actions.ts");
type TodoSeedActionsModule = typeof import("../modules/todos/todo.seed.actions.ts");
...
type TodoActions = InferActionsFromRecord<{
  addTodoNote: TodoPlatformActionsModule["addTodoNote"];
  assignTodo: TodoActionsModule["assignTodo"];
  completeTodo: TodoActionsModule["completeTodo"];
  createProject: ProjectActionsModule["createProject"];
  createTodo: TodoActionsModule["createTodo"];
  getTodoDashboard: TodoActionsModule["getTodoDashboard"];
  listProjects: ProjectActionsModule["listProjects"];
  listTodoActivityStream: TodoPlatformActionsModule["listTodoActivityStream"];
  listTodoAuditLog: TodoAuditActionsModule["listTodoAuditLog"];
  listTodoEvents: TodoAuditActionsModule["listTodoEvents"];
  listTodoNotifications: TodoAuditActionsModule["listTodoNotifications"];
  listTodoNotes: TodoPlatformActionsModule["listTodoNotes"];
  listTodos: TodoActionsModule["listTodos"];
  listWorkspacePreferences: TodoPlatformActionsModule["listWorkspacePreferences"];
  seedDemoWorkspace: TodoSeedActionsModule["seedDemoWorkspace"];
  setWorkspacePreference: TodoPlatformActionsModule["setWorkspacePreference"];
  startTodo: TodoActionsModule["startTodo"];
}>;
